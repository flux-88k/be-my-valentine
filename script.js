...
document.getElementById("yesButton").addEventListener("click", function() {
    document.getElementById("valentineImage").src = "images/funny-yes.gif"; // Change image
...
document.getElementById("noButton").addEventListener("click", function() {
    ...
    if (noClicks >= 3) {
        document.getElementById("valentineImage").src = "images/gato-triste.jpeg"; // Change to sad cat
